...
from api.core.config import settings  # Добавили импорт нашего конфига
from api.db.database import Base  # Добавили импорт нашей мета-БД
from api.db.models import Task,User  # Добавили импорт модели, чтобы она инициализировалась, но она не используется
